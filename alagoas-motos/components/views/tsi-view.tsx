    ...
    <div className="view-enter flex flex-col gap-5">
      ...
      {tsiData.length === 0 ? (
        <div className="rounded-2xl p-12 text-center cursor-pointer transition-colors" style={{ border: '2px dashed var(--border-line)', color: 'var(--text-muted)' }}
          onClick={onImport} onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.borderColor = '#d71920'; (e.currentTarget as HTMLElement).style.color = 'var(--text-primary)' }}
        ...
        <>
          {/* KPI grid */}
          <div className="responsive-grid responsive-grid-auto grid gap-4" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))' }}>
          ...
          {/* Gauges */}
          <div className="responsive-grid responsive-grid-2 grid gap-4" style={{ gridTemplateColumns: '1fr 1fr' }}>
          ...
          {/* Ranking + Matriz */}
          <div className="responsive-grid responsive-grid-2 grid gap-4" style={{ gridTemplateColumns: '1fr 1.1fr' }}>
          ...
          <div className="rounded-2xl p-5 glass-effect" style={{ border: '1px solid var(--border-line-soft)' }}>
            <h3 style={{ fontFamily: 'Rajdhani, sans-serif', fontSize: 17, fontWeight: 700, margin: '0 0 8px', color: 'var(--text-primary)', borderLeft: '3px solid #d71920', paddingLeft: 10 }}>
...
function Section({ title, sub, children }: { title: string; sub?: string; children: React.ReactNode }) {
  return (
    <div className="rounded-2xl p-5" style={{ background: 'var(--card-bg)', border: '1px solid var(--border-line-soft)' }}>
      <h3 style={{ fontFamily: 'Rajdhani, sans-serif', fontSize: 17, fontWeight: 700, margin: '0 0 14px', color: 'var(--text-primary)', borderLeft: '3px solid #d71920', paddingLeft: 10 }}>
